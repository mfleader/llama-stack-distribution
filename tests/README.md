...
export IMAGE_NAME="quay.io/opendatahub/ogx"
...
7. **Publish** multi-arch image to `quay.io/opendatahub/ogx` (on push to `main` or `rhoai-v*` branches when `distribution/` changed, or on manual dispatch)
